!(function (e, t, i, o) {
  ...
  (e.fn.lazyload = function (o) {
    ...
    return (
      ...
      this.each(function () {
        var t = this,
          i = e(t);
        (t.loaded = !1),
          (void 0 !== i.attr("src") && !1 !== i.attr("src")) ||
    ...
    (e.belowthefold = function (i, o) {
      return (
        (void 0 === o.container || o.container === t
          ? (t.innerHeight ? t.innerHeight : n.height()) + n.scrollTop()
          : e(o.container).offset().top + e(o.container).height()) <=
        e(i).offset().top - o.threshold
      );
    }),
    (e.rightoffold = function (i, o) {
      return (
        (void 0 === o.container || o.container === t
          ...
          : e(o.container).offset().left + e(o.container).width()) <=
        e(i).offset().left - o.threshold
      );
    }),
    (e.abovethetop = function (i, o) {
      return (
        (void 0 === o.container || o.container === t
          ? n.scrollTop()
          : e(o.container).offset().top) >=
        e(i).offset().top + o.threshold + e(i).height()
      );
    }),
    (e.leftofbegin = function (i, o) {
      return (
        (void 0 === o.container || o.container === t
          ? n.scrollLeft()
          : e(o.container).offset().left) >=
        e(i).offset().left + o.threshold + e(i).width()
      );
    }),
